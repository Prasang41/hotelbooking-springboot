...
import com.PrasangSingh41.HotelBooking.exceptions.InvalidBookingStateAndDateException;
import com.PrasangSingh41.HotelBooking.exceptions.NotFoundException;
import com.PrasangSingh41.HotelBooking.repository.RoomRepository;
import com.PrasangSingh41.HotelBooking.services.RoomService;
...
//    }
    ...
    private String saveImageToFrontend(MultipartFile imageFile) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Image upload failed: " + ex.getMessage());
        }

        // Return relative path that can be used in frontend
